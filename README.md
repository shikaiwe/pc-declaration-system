...
### 🔄 找回密码 (`forgot-password.html`)
- 📨 邮箱验证码验证
- 🔏 新密码设置
- 💪 密码强度检查
- 🔒 安全的密码重置流程

### 💻 PC端控制面板 (`dashboard.html`)
- 👤 用户信息显示和管理
- ☁️ 天气信息实时展示
- 📦 订单管理功能
  - ➕ 提交新订单
...
| 🛠️ 志愿者（worker） | • 查看被分配的订单<br>• 处理订单（完成/取消）<br>• 管理个人日程 |
...
---
© 2024 PC志愿者服务队管理系统. All Rights Reserved.
